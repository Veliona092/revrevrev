{{-- resources/views/layouts/appPsych.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rv-btn-primary { background: #B5526E; color: #fff; border-color: #B5526E; }
        .rv-btn-primary:hover { background: #993d59; border-color: #993d59; }
        .rv-btn-secondary { background: #F7EEF5; color: #5a4055; border-color: #E8D8E4; }
        .rv-btn-secondary:hover { border-color: #B5526E; color: #2D2D2B; }
        .rv-btn-danger { background: #F7EEF5; color: #C63F3E; border-color: #e8b8b7; }
        ...
        .rv-label { display: block; font-size: 14px; font-weight: 500; letter-spacing: 0.06em; text-transform: uppercase; color: #9a8098; margin-bottom: 8px; }
        .rv-input, .rv-select, .rv-textarea {
            width: 100%; padding: 12px 14px; border: 1px solid #E8D8E4; border-radius: 10px;
            font-family: var(--font); font-size: 17px; color: #2D2D2B; background: #FBF5F9; outline: none;
        ...
        .rv-input:focus, .rv-select:focus, .rv-textarea:focus { border-color: #B5526E; box-shadow: 0 0 0 3px rgba(181,82,110,0.08); }
        .rv-input::placeholder, .rv-textarea::placeholder { color: #C8AEC0; }
        .rv-select {
        ...
        .rv-drawer-head {
            padding: 24px 28px 18px; border-bottom: 1px solid #E8D8E4;
            display: flex; align-items: flex-start; justify-content: space-between; flex-shrink: 0;
        }
        .rv-drawer-title { font-family: var(--font-serif); font-size: 24px; color: #2D2D2B; font-weight: 500; }
        .rv-drawer-subtitle { font-size: 15px; color: #9a8098; margin-top: 4px; }
        .rv-drawer-close {
            width: 38px; height: 38px; border: 1px solid #E8D8E4; background: #F7EEF5;
            border-radius: 10px; cursor: pointer; display: flex; align-items: center;
            justify-content: center; font-size: 18px; color: #9a8098;
            transition: border-color 0.15s, color 0.15s; flex-shrink: 0;
        }
        .rv-drawer-close:hover { border-color: #B5526E; color: #B5526E; }
        .rv-drawer-body { flex: 1; overflow-y: auto; padding: 24px 28px; }
        .rv-drawer-body::-webkit-scrollbar { width: 4px; }
        .rv-drawer-body::-webkit-scrollbar-thumb { background: #E8D8E4; border-radius: 99px; }
        .rv-drawer-footer {
            padding: 16px 28px; border-top: 1px solid #E8D8E4;
