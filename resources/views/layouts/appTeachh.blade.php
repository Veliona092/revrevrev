...
<head>
    ...
    --nav-text: rgba(255,255,255,0.75);        /* was 0.5 → bumped up */
    --nav-text-hover: rgba(255,255,255,1);     /* was 0.9 → full white */
    ...
    --font-serif: 'DM Sans', sans-serif;
        ...
        body { font-family: var(--font); font-size: 17px; line-height: 1.55; background: var(--content-bg); color: #111; display: flex; min-height: 100vh; }
