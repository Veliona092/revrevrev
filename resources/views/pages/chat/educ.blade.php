...
<style>
    ...
    .ch-search-input:focus {
        border-color: #3A4180;
        box-shadow: 0 0 0 2px rgba(58, 65, 128, 0.08);
    }
    ...
    .ch-convo-item:hover { background: #fafafa; border-left-color: #c7e8ef; }
    .ch-convo-item.active { background: #f7f7f7; border-left-color: #3A4180; }
    ...
    .ch-online-dot {
        ...
        background: #3A4180; margin-right: 4px; vertical-align: middle; flex-shrink: 0;
    }
    ...
    .ch-main-status.online { color: #3A4180; font-weight: 500; }
    ...
    .ch-bubble-wrap.me   .ch-bubble { background: #3A4180; color: #fff; border-bottom-right-radius: 3px; }
    ...
    .ch-textarea:focus { border-color: #3A4180; box-shadow: 0 0 0 2px rgba(58, 65, 128, 0.08); }
    .ch-textarea::placeholder { color: #bbb; }

    .ch-send-btn {
        height: 34px; padding: 0 14px; background: #3A4180; color: #fff;
        border: none; border-radius: 6px;
        font-family: 'DM Sans', sans-serif; font-size: 14px; font-weight: 500;
        cursor: pointer; flex-shrink: 0; transition: background 0.15s, transform 0.1s;
    }

    .ch-send-btn:hover  { background: #2d3159; }
