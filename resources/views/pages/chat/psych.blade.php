@extends($layout ?? 'layouts.appPsych')
...
<style>
    ...
    .ch-search-input:focus {
        border-color: #3D2540;
        box-shadow: 0 0 0 2px rgba(61, 37, 64, 0.08);
    }
    ...
    .ch-search-name { font-size: 15px; font-weight: 500; color: #111; }
    .ch-search-role { font-size: 13px; color: #aaa; }
    .ch-search-empty { padding: 14px; font-size: 14px; color: #999; text-align: center; }
    ...
    .ch-count-badge {
        font-size: 13px; background: #f3f3f3; color: #555;
    ...
    .ch-convo-item:hover { background: #fafafa; border-left-color: #f5dbe8; }
    .ch-convo-item.active { background: #f7f7f7; border-left-color: #3D2540; }
    ...
    .ch-convo-time  { font-size: 13px; color: #aaa; flex-shrink: 0; }
    ...
    .ch-online-dot {
        ...
        background: #3D2540; margin-right: 4px; vertical-align: middle; flex-shrink: 0;
    }
    ...
    .ch-main-status.online { color: #3D2540; font-weight: 500; }

    .ch-refresh-btn {
        height: 32px; padding: 0 12px; background: transparent;
        border: 1px solid #e4e4e4; border-radius: 6px;
        font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; color: #555;
    ...
    /* ── Messages ── */
    .ch-messages {
        flex: 1; overflow-y: auto; padding: 24px 24px 14px;
    ...
    .ch-empty { margin: auto; text-align: center; color: #999; font-size: 15px; }
    ...
    .ch-bubble-wrap.me   .ch-bubble { background: #3D2540; color: #fff; border-bottom-right-radius: 3px; }
    .ch-bubble-wrap.them .ch-bubble { background: #f3f3f3; color: #111; border-bottom-left-radius: 3px; }

    .ch-bubble-meta { font-size: 12px; color: #aaa; margin-top: 4px; padding: 0 2px; }
    ...
    .ch-textarea {
        flex: 1; min-height: 42px; max-height: 140px; padding: 10px 12px;
    ...
    .ch-textarea:focus { border-color: #3D2540; box-shadow: 0 0 0 2px rgba(61, 37, 64, 0.08); }
    .ch-textarea::placeholder { color: #bbb; }

    .ch-send-btn {
        height: 34px; padding: 0 14px; background: #3D2540; color: #fff;
        border: none; border-radius: 6px;
        font-family: 'DM Sans', sans-serif; font-size: 14px; font-weight: 500;
        cursor: pointer; flex-shrink: 0; transition: background 0.15s, transform 0.1s;
    }

    .ch-send-btn:hover  { background: #2d1a2f; }
    .ch-send-btn:active { transform: scale(0.97); }
    .ch-send-btn:disabled { background: #ddd; cursor: not-allowed; }

    .ch-state { text-align: center; padding: 2rem 1rem; color: #999; font-size: 15px; }
