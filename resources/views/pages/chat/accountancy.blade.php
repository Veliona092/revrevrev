...
<style>
    ...
    .ch-search-input:focus {
        border-color: #C17F24;
        box-shadow: 0 0 0 2px rgba(193, 127, 36, 0.08);
    }
    ...
    .ch-convo-item:hover { background: #fafafa; border-left-color: #e8c99a; }
    .ch-convo-item.active { background: #f7f7f7; border-left-color: #C17F24; }
    ...
    .ch-online-dot {
        ...
        background: #C17F24; margin-right: 4px; vertical-align: middle; flex-shrink: 0;
    }
    ...
    .ch-main-status.online { color: #C17F24; font-weight: 500; }
    ...
    .ch-bubble-wrap.me   .ch-bubble { background: #C17F24; color: #fff; border-bottom-right-radius: 3px; }
    ...
    .ch-textarea:focus { border-color: #C17F24; box-shadow: 0 0 0 2px rgba(193, 127, 36, 0.08); }
    .ch-textarea::placeholder { color: #bbb; }

    .ch-send-btn {
        height: 34px; padding: 0 14px; background: #C17F24; color: #fff;
        border: none; border-radius: 6px;
        font-family: 'DM Sans', sans-serif; font-size: 14px; font-weight: 500;
        cursor: pointer; flex-shrink: 0; transition: background 0.15s, transform 0.1s;
    }

    .ch-send-btn:hover  { background: #9d6618; }
