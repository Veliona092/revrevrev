...
<style>
    ...
    .ch-search-input:focus {
        border-color: #245E55;
        box-shadow: 0 0 0 2px rgba(36, 94, 85, 0.08);
    }
    ...
    .ch-search-name { font-size: 16px; font-weight: 500; color: #111; }
    .ch-search-role { font-size: 16px; color: #aaa; }
    .ch-search-empty { padding: 12px; font-size: 16px; color: #999; text-align: center; }
    ...
    .ch-count-badge {
        font-size: 16px; background: #f3f3f3; color: #555;
    ...
    .ch-convo-item:hover { background: #fafafa; border-left-color: #a8d5cc; }
    .ch-convo-item.active { background: #f7f7f7; border-left-color: #245E55; }
    ...
    .ch-convo-name {
        font-size: 16px; font-weight: 500; color: #111; margin: 0;
        white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 170px;
    }

    .ch-convo-time  { font-size: 16px; color: #aaa; flex-shrink: 0; }
    ...
    .ch-online-dot {
        ...
        background: #245E55; margin-right: 4px; vertical-align: middle; flex-shrink: 0;
    }
    ...
    .ch-main-name   { font-size: 16px; font-weight: 500; color: #111; margin: 0 0 2px; }
    ...
    .ch-main-status.online { color: #245E55; font-weight: 500; }

    .ch-refresh-btn {
        height: 26px; padding: 0 10px; background: transparent;
        border: 1px solid #e4e4e4; border-radius: 6px;
        font-family: 'DM Sans', sans-serif; font-size: 16px; font-weight: 500; color: #555;
    ...
    .ch-empty { margin: auto; text-align: center; color: #999; font-size: 16px; }
    ...
    .ch-bubble-wrap.me   .ch-bubble { background: #245E55; color: #fff; border-bottom-right-radius: 3px; }
    .ch-bubble-wrap.them .ch-bubble { background: #f3f3f3; color: #111; border-bottom-left-radius: 3px; }

    .ch-bubble-meta { font-size: 16px; color: #aaa; margin-top: 3px; padding: 0 2px; }
    ...
    .ch-textarea:focus { border-color: #245E55; box-shadow: 0 0 0 2px rgba(36, 94, 85, 0.08); }
    .ch-textarea::placeholder { color: #bbb; }

    .ch-send-btn {
        height: 28px; padding: 0 12px; background: #245E55; color: #fff;
        border: none; border-radius: 6px;
        font-family: 'DM Sans', sans-serif; font-size: 16px; font-weight: 500;
        cursor: pointer; flex-shrink: 0; transition: background 0.15s, transform 0.1s;
    }

    .ch-send-btn:hover  { background: #1a4840; }
    .ch-send-btn:active { transform: scale(0.97); }
    .ch-send-btn:disabled { background: #ddd; cursor: not-allowed; }

    .ch-state { text-align: center; padding: 2rem 1rem; color: #999; font-size: 16px; }
...
<script>
    ...
    $(document).on('click', '.ch-search-item[data-user-id]', function () {
        ...
        $.post('/chat/conversations', { _token: csrfToken, target_user_id: userId })
            ...
            }).fail(xhr => showChatToast(xhr.responseJSON?.message || 'Unable to start chat.', 'error'));
    });
    ...
    function sendMessage() {
        ...
        $.post(`/chat/conversations/${activeChatId}/messages`, { _token: csrfToken, body })
            .done(function (res) {
                ...
                .fail(() => showChatToast('Message failed to send.', 'error'))
