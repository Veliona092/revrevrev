    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="progress" style="height: 30px;">
                <div class="progress-bar bg-success" role="progressbar" style="width: {{ $overallCompletion }}%" aria-valuenow="{{ $overallCompletion }}" aria-valuemin="0" aria-valuemax="100">
                    {{ $overallCompletion }}%
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Open Module Button -->
                    <a href="#" class="btn btn-primary mt-3">Open Module</a>
                </div>
            </div>
        </div>
        @empty
