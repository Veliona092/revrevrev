...
<head>
  ...
  <style>
    ...
    .form-control-custom:focus {
      ...
      box-shadow: 0 0 0 0.2rem rgba(193, 127, 36, 0.20);
    }
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-yelo" id="sidenav-main">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-light bg-yelotwo" id="navbar-main">
      <div class="container-fluid">
        <a class="h4 mb-0 text-black text-uppercase d-none d-lg-inline-block" href="{{ route('dashboard') }}">
          Account Settings
        </a>
