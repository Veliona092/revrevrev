...
<style>
    ...
    .mc-sub { font-size: 16px; color: #9a8f80; margin: -6px 0 8px; }
    ...
    .mc-empty-icon {
        ...
        background: #F5E6CC; color: #C17F24;
        display: flex; align-items: center; justify-content: center;
        font-size: 24px;
    }

    .mc-empty-title { font-size: 18px; font-weight: 500; color: #2D2D2B; margin: 0; }
    .mc-empty-sub   { font-size: 16px; color: #9a8f80; margin: 0; max-width: 380px; }

    .mc-empty-btn {
        height: 42px; padding: 0 22px; background: #C17F24; color: #fff;
    ...
    .mc-empty-btn:hover { background: #a56a18; color: #fff; }
    ...
    .mc-stat-label { font-size: 14px; color: #9a8f80; margin: 0 0 2px; font-weight: 500; }
    .mc-stat-val   { font-family: 'DM Sans', sans-serif; font-size: 34px; color: #2D2D2B; line-height: 1; margin: 0; }
    ...
    .mc-card:hover { box-shadow: 0 4px 20px rgba(0,0,0,0.06); border-color: #C8BBA8; }
    ...
    .mc-card-badge {
        ...
        border-radius: 99px; background: #F0EAE0; color: #7a6a55;
        white-space: nowrap;
    }

    .mc-card-name { font-size: 18px; font-weight: 500; color: #2D2D2B; margin: 0 0 4px; }
    .mc-card-desc { font-size: 15px; color: #9a8f80; margin: 0; line-height: 1.5; }

    .mc-card-divider { height: 1px; background: #F0EAE0; }

    .mc-card-meta {
        display: flex; align-items: center; justify-content: space-between;
    }

    .mc-card-teacher { font-size: 15px; color: #9a8f80; display: flex; align-items: center; gap: 6px; }

    .mc-view-btn {
        height: 38px; padding: 0 15px;
        background: #C17F24; color: #fff; border: none;
    ...
    .mc-view-btn:hover { background: #a56a18; color: #fff; }
...
<div class="mc-wrap">
    ...
    @else
        ...
        <div class="mc-stats">
            <div class="mc-stat">
                <div class="mc-stat-icon" style="background:#F5E6CC;color:#C17F24;"><i class="fas fa-chalkboard"></i></div>
                <div>
            ...
            <div class="mc-stat">
                <div class="mc-stat-icon" style="background:#FAD89A;color:#8a5a10;"><i class="fas fa-layer-group"></i></div>
                <div>
