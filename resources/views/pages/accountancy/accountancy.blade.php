...
<style>
    ...
    .db-stat-label { font-size: 14px; color: #9a8f80; margin: 0 0 4px; font-weight: 500; letter-spacing: 0.03em; }
    ...
    .db-card-link  { font-size: 14px; color: #C8BBA8; text-decoration: none; transition: color 0.15s; }
    .db-card-link:hover { color: #C17F24; }
    ...
    .db-sched.blue  { background: #FBF3E8; }
    .db-sched.amber { background: #FDF6EC; }
    .db-sched-left  { display: flex; align-items: center; gap: 12px; min-width: 0; flex: 1; }
    ...
    .db-sched-sub   { font-size: 14px; color: #9a8f80; margin: 0; }
    .db-sched-sub.urgent { color: #C63F3E; font-weight: 500; }
    .db-join-btn    { display: inline-flex; align-items: center; justify-content: center; min-width: 190px; height: 36px; padding: 0 15px; background: #C17F24; color: #fff; border: none; border-radius: 9px; font-family: 'DM Sans', sans-serif; font-size: 14px; font-weight: 500; cursor: pointer; white-space: nowrap; text-decoration: none; flex-shrink: 0; transition: background 0.15s; }
    .db-join-btn:hover { background: #a56a18; }

    .db-assign { display: flex; align-items: center; justify-content: space-between; padding: 12px 0; border-bottom: 1px solid #F0EAE0; }
    ...
    .db-bar-track { height: 8px; background: #E8E0D0; border-radius: 99px; overflow: hidden; }
    .db-bar-fill  { height: 100%; border-radius: 99px; transition: width 0.6s ease; }
    .db-detail-link { display: block; text-align: right; margin-top: 14px; font-size: 14px; color: #C8BBA8; text-decoration: none; transition: color 0.15s; }
    .db-detail-link:hover { color: #C17F24; }

    .db-announce { display: flex; align-items: flex-start; gap: 12px; padding: 11px 0; border-bottom: 1px solid #F0EAE0; }
    ...
    .db-announce-label { font-size: 14px; color: #C8BBA8; margin: 0 0 2px; }
    .db-announce-text  { font-size: 16px; color: #4a3c2c; font-weight: 500; margin: 0; }

    .db-msg { display: flex; align-items: flex-start; gap: 12px; }
    .db-msg-avatar { width: 40px; height: 40px; border-radius: 50%; background: #C17F24; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: 500; flex-shrink: 0; }
    .db-msg-name { font-size: 16px; font-weight: 500; color: #2D2D2B; margin: 0 0 3px; }
    .db-msg-body { font-size: 15px; color: #9a8f80; margin: 0; font-style: italic; }
