...
<head>
  ...
  <style>
    ...
    .nav-btn { text-align:center; padding:8px 10px; border-radius:6px; border:1px solid #e8e8e8; background:#fff; cursor:pointer; min-width:48px; font-weight:500; }
    ...
    .failed-svg .failed-text { position:absolute; left:0; right:0; top:22px; text-align:center; color:#fff; font-weight:500; font-size:20px; letter-spacing:0.4px; }
    .failed-desc { text-align:center; color:var(--danger); font-weight:500; margin-top:8px; }
    /* responsive */
  ...
  <div class="sidebar" aria-hidden="false">
    ...
    <div class="exam-item" data-exam-id="exam-1">
      <div>
        ...
        <div style="font-size:13px;color:var(--muted)">10 questions · 30 minutes</div>
      </div>
      <div>
...
(function(){
  ...
  function createNavButton(index, isAnswered, isCurrent, visible){
    ...
    btn.textContent = `Q${index+1}` + (isAnswered ? ' ✓' : '');
