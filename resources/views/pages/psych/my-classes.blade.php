...
<style>
    ...
    .mc-sub { font-size: 16px; color: #9a8098; margin: -6px 0 8px; }
    ...
    .mc-empty-icon {
        ...
        background: #F2D8EA; color: #B5526E;
        display: flex; align-items: center; justify-content: center;
        font-size: 24px;
    }

    .mc-empty-title { font-size: 18px; font-weight: 500; color: #2D2D2B; margin: 0; }
    .mc-empty-sub   { font-size: 16px; color: #9a8098; margin: 0; max-width: 380px; }

    .mc-empty-btn {
        height: 42px; padding: 0 22px; background: #B5526E; color: #fff;
    ...
    .mc-card-divider { height: 1px; background: #EDD8E8; }
    ...
    .mc-view-btn {
        ...
        background: #B5526E; color: #fff; border: none;
    ...
    .mc-view-btn:hover { background: #993d59; color: #fff; }
...
<div class="mc-wrap">
    ...
    @else
        ...
        <div class="mc-stats">
            <div class="mc-stat">
                <div class="mc-stat-icon" style="background:#F2D8EA;color:#B5526E;"><i class="fas fa-chalkboard"></i></div>
                <div>
