...
<style>
    ...
    .db-stat-label { font-size: 14px; color: #9a8098; margin: 0 0 4px; font-weight: 500; letter-spacing: 0.03em; }
    .db-stat-val   { font-family: 'DM Sans', sans-serif; font-size: 34px; color: #2D2D2B; line-height: 1; margin: 0; }
    ...
    .db-card-title { font-size: 16px; font-weight: 500; color: #2D2D2B; margin: 0; }
    .db-card-link  { font-size: 14px; color: #C8AEC0; text-decoration: none; transition: color 0.15s; }
    .db-card-link:hover { color: #B5526E; }
    ...
    .db-sched.blue  { background: #F7EEF5; }
    .db-sched.amber { background: #FBF0F5; }
    ...
    .db-sched-icon.blue  { background: #F2D8EA; color: #B5526E; }
    .db-sched-icon.amber { background: #EAA7C7; color: #7a2e4a; }
    .db-sched-name  { font-size: 16px; font-weight: 500; color: #2D2D2B; margin: 0 0 2px; }
    .db-sched-sub   { font-size: 14px; color: #9a8098; margin: 0; }
    .db-sched-sub.urgent { color: #C63F3E; font-weight: 500; }
    .db-join-btn    { display: inline-flex; align-items: center; justify-content: center; min-width: 190px; height: 36px; padding: 0 15px; background: #B5526E; color: #fff; border: none; border-radius: 9px; font-family: 'DM Sans', sans-serif; font-size: 14px; font-weight: 500; cursor: pointer; white-space: nowrap; text-decoration: none; transition: background 0.15s; }
    .db-join-btn:hover { background: #993d59; }

    /* ── Assignments ── */
    .db-assign { display: flex; align-items: center; justify-content: space-between; padding: 12px 0; border-bottom: 1px solid #EDD8E8; }
    ...
    .db-assign-name { font-size: 16px; font-weight: 500; color: #2D2D2B; margin: 0; }
    .db-badge { font-size: 14px; font-weight: 500; padding: 4px 11px; border-radius: 99px; white-space: nowrap; }
    .db-badge.warning { background: #F2D8EA; color: #7a2e4a; }
    ...
    .db-prog-subject { color: #5a4055; font-weight: 500; }
    .db-prog-val { font-weight: 500; }
    .db-prog-val.green { color: #245E55; }
    .db-prog-val.red   { color: #C63F3E; }
    .db-bar-track { height: 8px; background: #E8D8E4; border-radius: 99px; overflow: hidden; }
    .db-bar-fill  { height: 100%; border-radius: 99px; transition: width 0.6s ease; }
    .db-detail-link { display: block; text-align: right; margin-top: 14px; font-size: 14px; color: #C8AEC0; text-decoration: none; transition: color 0.15s; }
    .db-detail-link:hover { color: #B5526E; }

    /* ── Announcements ── */
    .db-announce { display: flex; align-items: flex-start; gap: 12px; padding: 11px 0; border-bottom: 1px solid #EDD8E8; }
    ...
    .db-announce-label { font-size: 14px; color: #C8AEC0; margin: 0 0 2px; }
    .db-announce-text  { font-size: 16px; color: #3d2030; font-weight: 500; margin: 0; }

    /* ── Messages ── */
    .db-msg { display: flex; align-items: flex-start; gap: 12px; }
    .db-msg-avatar { width: 40px; height: 40px; border-radius: 50%; background: #B5526E; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: 500; flex-shrink: 0; }
    .db-msg-name { font-size: 16px; font-weight: 500; color: #2D2D2B; margin: 0 0 3px; }
    .db-msg-body { font-size: 15px; color: #9a8098; margin: 0; font-style: italic; }
...
<div class="db-wrap">
    ...
    <div class="db-stats">
        <div class="db-stat">
            <div class="db-stat-icon" style="background:#F2D8EA;color:#B5526E;">
        ...
        <div class="db-stat">
            <div class="db-stat-icon" style="background:#EAA7C7;color:#7a2e4a;">
        ...
        <div style="display:flex;flex-direction:column;gap:14px;">
            ...
            <div class="db-card">
                ...
                <div class="db-card-body">
                    ...
                    @empty
                        <p style="font-size:13px;color:#9a8098;text-align:center;padding:16px 0;">No pre-assessments yet.</p>
                    @endforelse
            ...
            <div class="db-card">
                ...
                <div class="db-card-body">
                    @forelse($pendingQuizModules as $module)
                        <div class="db-assign">
                            <div class="db-assign-left">
                                <div class="db-assign-icon" style="background:#FBF0F5;color:#7a2e4a;"><i class="fas fa-file-alt"></i></div>
                    ...
                    @if($pendingQuizModules->isEmpty() && $gradedAttempts->isEmpty() && $submittedAttempts->isEmpty())
                        <p style="font-size:13px;color:#9a8098;text-align:center;padding:8px 0;">No assessment activity yet.</p>
                    @endif
                </div>
            </div>
        ...
        <div class="db-right">
            ...
            <div class="db-card">
                ...
                <div class="db-card-body">
                    ...
                    @empty
                        <p style="font-size:13px;color:#9a8098;text-align:center;padding:8px 0;">No quiz data yet.</p>
                    @endforelse
       ...
       <div class="db-card">
                ...
                <div class="db-card-body">
                    @forelse($announcements as $announcement)
                        <div class="db-announce db-announce-clickable" data-announcement-id="{{ $announcement->id }}" onclick="toggleAnnounceThread({{ $announcement->id }})" style="cursor:pointer;">
                            <div class="db-announce-icon" style="background:#F2D8EA;color:#B5526E;"><i class="fas fa-bell"></i></div>
                            <div style="flex:1;">
                    ...
                    @empty
                        <p style="font-size:13px;color:#9a8098;text-align:center;padding:8px 0;">No announcements yet.</p>
                    @endforelse
                </div>
            </div>
            ...
            <div class="db-card">
                ...
                <div class="db-card-body">
                    ...
                    @empty
                        <p style="font-size:13px;color:#9a8098;text-align:center;padding:8px 0;">No messages yet.</p>
                    @endforelse
                </div>
            </div>
