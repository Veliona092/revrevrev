...
Gate::define('manage-mock-board', function (User $user, \App\Models\MockBoard $mockBoard): bool {
    return $user->id === $mockBoard->teacher_id
        || in_array($user->role, ['admin', 'superadmin']);
});

Gate::define('view-mock-board', function (User $user, \App\Models\MockBoard $mockBoard): bool {
